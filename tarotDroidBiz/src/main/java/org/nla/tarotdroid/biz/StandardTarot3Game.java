 ...
 *	A tarot game.
 */
public class StandardTarot3Game extends StandardBaseGame {
		
	/**
     * Serial version ID.
     */
	@CloudField(cloudify=false)
    private static final long serialVersionUID = 4156114293894169247L;

    /**
	 * Default Constructor.	
	 */
	public StandardTarot3Game() {
		super();
	}
	...
	public void setPlayers(final PlayerList players) {
		if (players.size() != 3) {
			throw new IllegalArgumentException("players must be exactly three =" + players.size());
		}
	...
	public GameScores getGameScores() {
		BaseGameScoresComputer gameScoresComputer = new StandardTarot3GameScoresComputer(this, this.gameSetParameters);
