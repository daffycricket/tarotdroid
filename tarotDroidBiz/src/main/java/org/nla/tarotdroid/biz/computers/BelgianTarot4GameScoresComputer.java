 ...
 *
 */
public class BelgianTarot4GameScoresComputer extends BaseGameScoresComputer {
	 ...
	 */
	private BelgianTarot4Game game;
	 ...
	 */
	public BelgianTarot4GameScoresComputer(final BelgianTarot4Game game, final GameSetParameters gameSetParameters) {
		super();
	 ...
	 * @param game
	 */
	public BelgianTarot4GameScoresComputer(final BelgianTarot4Game game) {
	...
	public void computeScore() {
		...
		this.scores.addScore(this.game.getFourth(), -this.baseStepPoints * 2);
	}
}
