...
public class LeadingPlayersStatsChart extends BaseStatsChart {
	 ...
	 */
	public LeadingPlayersStatsChart(final IGameSetStatisticsComputer gameSetStatisticsComputer) {
		super(
			AppContext.getApplication().getResources().getString(R.string.statNameLeadingPlayerFrequency),
			AppContext.getApplication().getResources().getString(R.string.statDescLeadingPlayerFrequency),
